      ...
      <div className="py-6 px-6 sm:px-12">
        <div className="row">
          ...
          <ul className="project__list">
            <Link href="https://www.autoshops.com/">
            ...
            <Link href="https://summarist-internship-fawn.vercel.app/">
              <li className="project">
                <div className="project__wrapper rounded-md border border-green-500/40">
                  <div className="project__wrapper--background"></div>
                  <img
            ...
            <Link href="https://movie-react-site.vercel.app/">
              <li className="project">
                <div className="project__wrapper rounded-md border border-green-500/40">
                  <div className="project__wrapper--background"></div>
                  <img
            ...
            <Link href="https://broady-internship.vercel.app/">
              <li className="project">
                <div className="project__wrapper rounded-md border border-green-500/40">
                  <div className="project__wrapper--background"></div>
                  <img
            ...
            <Link href="https://library-react-53d28fe01db4.herokuapp.com/">
              <li className="project">
                <div className="project__wrapper rounded-md border border-green-500/40">
                  <div className="project__wrapper--background"></div>
                  <img
